...
metadata labels or user-chosen generation IDs in the current schema
node matching selectors in the current schema
bootloader, loader entry, or kernel argument policy in the current schema
artifact trust-root or signing policy in the current schema
