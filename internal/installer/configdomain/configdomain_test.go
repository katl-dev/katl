...
func TestNativeEtcFilesRendersKnownDomains(t *testing.T) {
	...
	want := []string{
		...
		"/etc/systemd/system/katl-configured-units.target",
		"/etc/tmpfiles.d/80-katl-sysfs.conf",
	}
	...
	if files[8].Content != "# Generated by Katl from hostConfiguration.sysfs.\nw~ /sys/module/printk/parameters/time - - - - Tg==\n" {
		t.Fatalf("sysfs tmpfiles content = %q", files[8].Content)
	}
}
